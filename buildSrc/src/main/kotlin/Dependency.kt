...
private object Versions {
    ...
    const val CORE_MATERIAL   = "1.2.0-alpha02"
    const val CORE_KOIN       = "2.0.1"

    const val JETPACK_CORE              = "1.2.0-rc01"
    const val JETPACK_APP_COMPAT        = "1.1.0"
    const val JETPACK_LIFECYCLE         = "2.2.0-rc02"
    const val JETPACK_ACTIVITY          = "1.1.0-rc02"
    const val JETPACK_CONSTRAINT_LAYOUT = "2.0.0-beta3"
    const val JETPACK_RECYCLER_VIEW     = "1.1.0"
    const val JETPACK_COLLECTION        = "1.1.0"

    const val EXTRA_ZPACK                   = "0.7.6"
    const val EXTRA_SIMPLE_PREF             = "2.2.2"
    const val EXTRA_LOTTIE_DIALOG           = "3.5.1"
    const val EXTRA_TOOLBAR_BADGE_MENU_ITEM = "3.0.0"
