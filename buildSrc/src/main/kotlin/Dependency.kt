...
private object Versions {
    ...
    const val CORE_MATERIAL   = "1.2.0-alpha05"
    const val CORE_KOIN       = "2.1.4"

    const val JETPACK_CORE              = "1.3.0-alpha02"
    const val JETPACK_APP_COMPAT        = "1.2.0-alpha03"
    const val JETPACK_LIFECYCLE         = "2.3.0-alpha01"
    const val JETPACK_ACTIVITY          = "1.2.0-alpha01"
    const val JETPACK_CONSTRAINT_LAYOUT = "2.0.0-beta4"
    const val JETPACK_RECYCLER_VIEW     = "1.2.0-alpha01"
    const val JETPACK_COLLECTION        = "1.1.0"

    const val EXTRA_ZPACK                   = "0.8.3"
    const val EXTRA_SIMPLE_PREF             = "2.4.0"
    const val EXTRA_LOTTIE_DIALOG           = "3.7.0"
    const val EXTRA_TOOLBAR_BADGE_MENU_ITEM = "3.0.1"
    const val EXTRA_ONCE                    = "1.3.0"
    const val EXTRA_RECYCLER_VIEW_ANIMATORS = "3.0.0"
    const val EXTRA_TAP_TARGET_VIEW         = "1.13.0"

    const val TESTING_CORE        = "1.3.0-alpha04"
    const val TESTING_RULES       = "1.3.0-alpha04"
    const val TESTING_RUNNER      = "1.3.0-alpha04"
    const val TESTING_ESPRESSO    = "3.3.0-alpha04"
    const val TESTING_EXT_JUNIT   = "1.1.2-alpha04"
    const val TESTING_EXT_TRUTH   = "1.3.0-alpha04"
